...
class _SinglyIntroductionState extends State<SinglyIntroduction> {
  ...
  void forward() {
    ...
    else if (animationState == 4) tailPointerArrowOpacity = 1;
    animationState++;
  }
  ...
  Widget build(BuildContext context) {
    ...
    path = ['Home', 'DS', 'Linked List', 'Singly', 'Intro'];
                      ...
                      Row(
                        children: [
                          ...
                          ArrowElement(
                            ...
                            color: Colors.white
                                .withOpacity(headPointerArrowOpacity),
                            child: Text(
                              'Head Pointer',
                              style: TextStyle(
                                  color: Colors.white
                                      .withOpacity(headPointerOpacity),
                          ...
                          ArrowElement(
                            ...
                            targetAnchor: Alignment.topCenter,
                            color: Colors.white
                                .withOpacity(tailPointerArrowOpacity),
                            child: Text(
                              'Tail Pointer',
                              style: TextStyle(
                                  color: Colors.white
                                      .withOpacity(tailPointerOpacity),
                                  fontSize: height * 0.02),
                            ),
                          ),
                        ],
