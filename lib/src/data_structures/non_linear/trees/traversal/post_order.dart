...
class PostOrderTraversal extends StatefulWidget {
  @override
  _PostOrderTraversalState createState() => _PostOrderTraversalState();
}

class _PostOrderTraversalState extends State<PostOrderTraversal> {
  int visited = 0;
